    ...
    return (
        <StyledHeader $scrollEvent={scrollEvent} $is404={is404}>
            <div className="container p-0">
                <div className="d middle between">
                    <div className="d middle gap-3">
                        ...
                        <div className="d gap-3">
                            {!mobile && menuItems.map((i, k) => (
                                <React.Fragment key={k}>
                                    ...
                                    {!i.link && (
                                        <DropDown title={i.title} options={i.items} openDropDown={openDropDown} setOpenDropDown={setOpenDropDown} scrollEvent={scrollEvent} isMobile={mobile} is404={is404} />
                                    )}
                                </React.Fragment>
                            ))}
                            {!!mobile && (
